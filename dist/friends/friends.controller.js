...
let FriendsController = class FriendsController {
    ...
    async getFriendWorkoutBlock(req, friendUserId, workoutId, blockId) {
        return this.friendsService.getFriendWorkoutBlock(req.user.id, friendUserId, workoutId, blockId);
    }
...
__decorate([
    (0, common_1.Get)(":friendUserId/workouts/:workoutId/blocks/:blockId"),
    (0, swagger_1.ApiOperation)({ summary: "Get friend active workout block details" }),
    (0, swagger_1.ApiParam)({ name: "friendUserId", type: Number }),
    (0, swagger_1.ApiParam)({ name: "workoutId", type: Number }),
    (0, swagger_1.ApiParam)({ name: "blockId", type: Number }),
    (0, swagger_1.ApiResponse)({
        status: 200,
    ...
    __param(1, (0, common_1.Param)("friendUserId", common_1.ParseIntPipe)),
    __param(2, (0, common_1.Param)("workoutId", common_1.ParseIntPipe)),
    __param(3, (0, common_1.Param)("blockId", common_1.ParseIntPipe)),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, Number, Number, Number]),
    __metadata("design:returntype", Promise)
], FriendsController.prototype, "getFriendWorkoutBlock", null);
__decorate([
